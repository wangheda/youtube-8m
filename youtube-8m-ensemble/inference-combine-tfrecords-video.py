...
def inference_loop(video_ids_batch, labels_batch, inputs_batch, predictions_batch,
  ...
  with tf.Session() as sess:
    ...
    fetches = [video_ids_batch, labels_batch, inputs_batch, predictions_batch]
...
def main(unused_argv):
  ...
  with tf.Graph().as_default():
    ...
    inference_loop(video_ids_batch, labels_batch, inputs_batch, predictions_batch,
