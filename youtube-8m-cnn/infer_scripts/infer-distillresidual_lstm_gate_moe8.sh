...
#for part in ensemble_validate; do 
    CUDA_VISIBLE_DEVICES=0 python inference-pre-ensemble-distill.py \
	      --output_dir="/Youtube-8M/model_predictions/${part}/distillresidual_lstm_gate_moe8" \
          --model_checkpoint_path="/home/zhangt/yt8m/frame_level_lstm_gate_distill_model/model.ckpt-84019" \
	      ...
	      --distill_sizes="4716" \
          --model=LstmGateModel \
          --video_level_classifier_model=MoeDistillModel \
          --moe_num_extend=4 \
          --moe_method=None \
          --lstm_cells=1024 \
          --moe_num_mixtures=8 \
